...
<img src="public/mdImgs/image-20220210135808631.png" alt="image-20220210135808631" style="zoom:50%;" />

增加了新的内容，再次使用`git commit`任务提交新内容之后：

<img src="public/mdImgs/image-20220210135912104.png" alt="image-20220210135912104" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210140153996.png" alt="image-20220210140153996" style="zoom:50%;" />

现在，我们要新增一个功能，为此我们想创建一个名为`newImage`的新分支：

`git branch newImage`

<img src="public/mdImgs/image-20220210140307559.png" alt="image-20220210140307559" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210140521088.png" alt="image-20220210140521088" style="zoom:50%;" />

现在，所有新增的内容再`commit`，则会以当前分支为起点创建新的节点`c2`：

<img src="public/mdImgs/image-20220210140612918.png" alt="image-20220210140612918" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210141214004.png" alt="image-20220210141214004" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210141330337.png" alt="image-20220210141330337" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210141605243.png" alt="image-20220210141605243" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210144128221.png" alt="image-20220210144128221" style="zoom:50%;" />

在`bugFix`分支上执行命令：`git rebase main`

<img src="public/mdImgs/image-20220210144738544.png" alt="image-20220210144738544" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210145113041.png" alt="image-20220210145113041" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210150937337.png" alt="image-20220210150937337" style="zoom:50%;" />

此时 HEAD 指向 main，main 指向 C1！

我们可以通过`git checkout C1`（C1 指代提交记录的哈希值）来分离 HEAD！

<img src="public/mdImgs/image-20220210151253672.png" alt="image-20220210151253672" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210151826055.png" alt="image-20220210151826055" style="zoom:50%;" />

现在，我们可以使用`git checkout main^`来切换到`main`分支的父节点。

<img src="public/mdImgs/image-20220210151958145.png" alt="image-20220210151958145" style="zoom:50%;" />

比如我们有这样一个场景：

<img src="public/mdImgs/image-20220210152303465.png" alt="image-20220210152303465" style="zoom:50%;" />

现在需要让`main`分支恢复到节点`C1`:

`git branch -f main HEAD~3`即可强制让`main`分支相对引用上层第三个节点。

<img src="public/mdImgs/image-20220210152439000.png" alt="image-20220210152439000" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210153918207.png" alt="image-20220210153918207" style="zoom:50%;" />

然后执行重置命令：`git reset HEAD^`

<img src="public/mdImgs/image-20220210153956095.png" alt="image-20220210153956095" style="zoom:50%;" />

##### revert

> Reset 通常用于修改本地提交记录，如果需要撤销更改并且分享给别人，则需要`git revert`

<img src="public/mdImgs/image-20220210154110580.png" alt="image-20220210154110580" style="zoom:50%;" />

执行命令`git revert HEAD`:

<img src="public/mdImgs/image-20220210155612888.png" alt="image-20220210155612888" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210164646032.png" alt="image-20220210164646032" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210165225268.png" alt="image-20220210165225268" style="zoom:50%;" />
...
![image-20220210174950934](public/mdImgs/image-20220210174950934.png)
...
<img src="public/mdImgs/image-20220210180636221.png" alt="image-20220210180636221" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210182452714.png" alt="image-20220210182452714" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210181703119.png" alt="image-20220210181703119" style="zoom:50%;" />
...
<img src="public/mdImgs/image-20220210212704433.png" alt="image-20220210212704433" style="zoom: 67%;" />
...
![image-20220210214641095](public/mdImgs/image-20220210214641095.png)
...
![image-20220210215346574](public/mdImgs/image-20220210215346574.png)
...
![image-20220210215752988](public/mdImgs/image-20220210215752988.png)
...
![image-20220210224729142](public/mdImgs/image-20220210224729142.png)
...
![image-20220210224814517](public/mdImgs/image-20220210224814517.png)
...
![image-20220210225857113](public/mdImgs/image-20220210225857113.png)
...
![image-20220210231612410](public/mdImgs/image-20220210231612410.png)
...
![image-20220210233314336](public/mdImgs/image-20220210233314336.png)
...
![image-20220210233534390](public/mdImgs/image-20220210233534390.png)
...
![image-20220210235203491](public/mdImgs/image-20220210235203491.png)
...
![image-20220210235444896](public/mdImgs/image-20220210235444896.png)
